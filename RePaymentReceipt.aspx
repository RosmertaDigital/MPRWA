<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RePaymentReceipt.aspx.cs" Inherits="BMHSRPv2.RePaymentReceipt" %>
            ...
            <div class="color1 view-data">
                <div class="in_pages page1 clearfix">
                    <div class="addedspace width50 width40">
                        <div class="clearfix">
                            <div class="leftshow">
                                <h4>Receipt of Payment & Re-Appointment</h4>
                        ...
                        <div class="rightshow"><p>HSRP Online Re-Appointment Transaction Reciept<br>
                            ...
                            <div class="grey">
                                ...
                                <ul>
                                   ...
                                   <%-- <li>If payment is not seccessfull Process Booking Again.</li>--%>
                                    ...
                                    <li>Re-Appointment (if any) will only avaiable for future dates.
                                    </li>
