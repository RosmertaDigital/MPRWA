...
namespace BMHSRPv2
{
    public partial class FinalCancelStep : System.Web.UI.Page
    {
        string Qstr = string.Empty;
        string order_status = "Already Cancelled";
        ...
        //        string HsrpOrderStatus = string.Empty;
        //        //Check  OrderStatus in HSRPOEM if OrderStatus="New Order" then insert and delete
        //        string selectStatus = "Select top 1 isnull(OrderStatus,'') OrderStatus,OrderNo FROM HSRPOEM.dbo.hsrprecords  WHERE  OrderNo='" + lblorderno.InnerText.Trim() + "' and VehicleRegNo='"+ lblVehicleNo.InnerText.Trim() + "'  and IsBookMyHsrpRecord ='Y' ";
        //        DataTable _status = Utils.GetDataTable(selectStatus, constr);
        //        if (_status.Rows.Count > 0)
        //        {
        //            HsrpOrderStatus = _status.Rows[0]["OrderStatus"].ToString();
        ...
        //        /* string Reason = ddlReason.Items[ddlReason.SelectedIndex].Text + " -- Remark: " + txtother.Value.ToString();
        //         string InsertQuery = " Insert into HSRPOEM.dbo.CancelledLog(OrderNo,VehicleNo,AppointmentDate,AppointmentSlot,EngineNo,ChassisNo,VehicleMake,FuelType,FitmentAddress,VehicleType,VehicleClass,Reason,CancelledDate,OrderStatus,PrevOrderStatus)" +
        //                                     " Values('" + lblorderno.InnerText + "','" + lblVehicleNo.InnerText + "','" + lblAppointmentdate.InnerText + "','" + lblSlot.InnerText + "','" + lblEngineNo.InnerText + "','" + lblChassisNo.InnerText + "','" + lblVehicleMake.InnerText + "','" + lblFuelType.InnerText + "','" + lblVehiclemodel.InnerText + "','" + lblVehicletype.InnerText + "','" + lblVehicleclass.InnerText + "','" + Reason + "',GETDATE(),'ORDER CANCELLED','Success')";
        //         Utils.ExecNonQuery(InsertQuery, constr);
        ...
        //            try
        //            {
        //                string UpdateHSRPRecord = "UPDATE HSRPOEM.dbo.hsrprecords SET OrderStatus= 'ORDER CANCELLED' WHERE OrderNo='" + lblorderno.InnerText.Trim() + "' and VehicleRegNo='" + lblVehicleNo.InnerText.Trim() + "'   and IsBookMyHsrpRecord ='Y' ";
        //                Utils.ExecNonQuery(UpdateHSRPRecord, constr);

        //                string Query = "UPDATE Appointment_BookingHist SET OrderStatus='ORDER CANCELLED' WHERE OrderNo='" + lblorderno.InnerText.Trim() + "' and VehicleRegNo='" + lblVehicleNo.InnerText.Trim() + "'";
        //                Utils.ExecNonQuery(Query, constr);

        //                string checkBookApp = "select top 1 orderno from hsrpoem.dbo.BookMyHSRPAppointment WHERE OrderNo='" + lblorderno.InnerText.Trim() + "' and VehicleRegNo='" + lblVehicleNo.InnerText.Trim() + "'";
        //                DataTable dtbookapp = Utils.GetDataTable(checkBookApp, constr);
        //                if (dtbookapp.Rows.Count > 0)
        //                {
        //                    string updateBookApp = " UPDATE hsrpoem.dbo.BookMyHSRPAppointment SET OrderStatus = 'ORDER CANCELLED',Process = 'R',ProcessMessage = '" + Reason.ToString() + "' WHERE OrderNo='" + lblorderno.InnerText.Trim()+ "' and VehicleRegNo='" + lblVehicleNo.InnerText.Trim() + "'";
        //                    Utils.ExecNonQuery(updateBookApp, constr);
        //                }
        ...
        //            string InsertQuery = " Insert into HSRPOEM.dbo.CancelledLog(OrderNo,VehicleNo,AppointmentDate,AppointmentSlot,EngineNo,ChassisNo,VehicleMake,FuelType,FitmentAddress,VehicleType,VehicleClass,CancelledDate,ExceptionMsg)" +
        //                        " Values('" + lblorderno.InnerText + "','" + lblVehicleNo.InnerText + "','" + lblAppointmentdate.InnerText + "','" + lblSlot.InnerText + "','" + lblEngineNo.InnerText + "','" + lblChassisNo.InnerText + "','" + lblVehicleMake.InnerText + "','" + lblFuelType.InnerText + "','" + lblVehiclemodel.InnerText + "','" + lblVehicletype.InnerText + "','" + lblVehicleclass.InnerText + "',GETDATE(),'" + lblMsg.InnerText + "')";
        ...
        //    else
        //    {
        //        lblMsg.InnerText = "Your Order is already Cancelled ";
        //        lblMsg.Visible = true;
        //        string InsertQuery = " Insert into HSRPOEM.dbo.CancelledLog(OrderNo,VehicleNo,AppointmentDate,AppointmentSlot,EngineNo,ChassisNo,VehicleMake,FuelType,FitmentAddress,VehicleType,VehicleClass,CancelledDate,ExceptionMsg)" +
        //                    " Values('" + lblorderno.InnerText + "','" + lblVehicleNo.InnerText + "','" + lblAppointmentdate.InnerText + "','" + lblSlot.InnerText + "','" + lblEngineNo.InnerText + "','" + lblChassisNo.InnerText + "','" + lblVehicleMake.InnerText + "','" + lblFuelType.InnerText + "','" + lblVehiclemodel.InnerText + "','" + lblVehicletype.InnerText + "','" + lblVehicleclass.InnerText + "',GETDATE(),'" + lblMsg.InnerText + "')";
        ...
        protected void BtnConfirm_OnClick(object Source, EventArgs e)
        {
            ...
            if (Check == "success")
            {
                ...
                if (HsrpOrderStatus == "New Order" || HsrpOrderStatus == "")
                {
                    ...
                    try
                    {
                        #region MyRegion code is comment sql query based
                        ...
                        */
                        ...
                        string sqlText = "exec HSRPOEM.dbo.sp_bookmyhsrp_void '" + lblorderno.InnerText + "','" + Reason + "','" + lblVehicleNo.InnerText.Trim() + "'";
                        Utils.ExecNonQuery(sqlText, constr);
                        ...
                        Utils.ExecNonQuery(InsertQuery, constr);
                        Response.Redirect("CancellationReceived.aspx", false);

                    }
                    catch (Exception exmsg)
                    {

                        // capture is exception data !
                        string InsertQuery = " Insert into HSRPOEM.dbo.CancelledLog(OrderNo,VehicleNo,AppointmentDate,AppointmentSlot,EngineNo,ChassisNo,VehicleMake,FuelType,FitmentAddress,VehicleType,VehicleClass,CancelledDate,ExceptionMsg)" +
                                    " Values('" + lblorderno.InnerText + "','" + lblVehicleNo.InnerText + "','" + lblAppointmentdate.InnerText + "','" + lblSlot.InnerText + "','" + lblEngineNo.InnerText + "','" + lblChassisNo.InnerText + "','" + lblVehicleMake.InnerText + "','" + lblFuelType.InnerText + "','" + lblVehiclemodel.InnerText + "','" + lblVehicletype.InnerText + "','" + lblVehicleclass.InnerText + "',GETDATE(),'" + exmsg.Message + "')";
                        Utils.ExecNonQuery(InsertQuery, constr);
