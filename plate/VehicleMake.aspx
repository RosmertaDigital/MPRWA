<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VehicleMake.aspx.cs" Inherits="BMHSRPv2.plate.VehicleMake" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.OemClick').click(function () {
               ...
               //alert(status);
                var src = $(this).children('img').first().attr('src');
                var _nonhomo = $(this).children('img').first().attr('longdesc');
                //var ImagePath = $('#' + status).find('.OemClick').find('img').map(function () { return this.src; }).get();
                ...
                var oemid = status;// $("#ContentPlaceHolder1_HiddenOemid").val();
                    ...
                    jQuery.ajax({
                        type: "GET",
                        url: "api/Get/SetOEM?OEMId=" + oemid + "&OEMImgPath=" + oemimg +"&nonhomo="+_nonhomo,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
                            data = response;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul>
        ...
        <a href="../index.aspx" class="gobacks"><img src="../assets/img/back.svg"></a>
    </div>
</div>            <div class="view-data color5">
                <div class="in_pages page1">
                    ...
                    <div class="details">
                        ...
                        <div class="brand-selection ">
                            ...
                            <asp:Literal runat="server" ID="ratedis"></asp:Literal>
