<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaymentReceiptCCAvenue.aspx.cs" Inherits="BMHSRPv2.plate.PaymentReceiptCCAvenue" %>
                    ...
                    <div class="addedspace printpage width50 width60">
                        <div class="printarea">
                            <div class="white">
                                ...
                                <div class="table-show">
                                    <table>
                                        ...
                                        <tr>
                                            <td>Payment/Order Status/status_massage :</td>
                                            <td>
                            ...
                            <div class="grey">
                                <p>Please note:</p>
                                <ul>
                                    <li>Carry of this receipt, SMS and RC copy at the time of appointment.</li>
                                   <%-- <li>If payment is not seccessfull Process Booking Again.</li>--%>
                                    <li>if you have queries, Please contact Toll Free 18001200201, Email ID :
                                        online@rosmertahsrp.com
                                    </li>
                                    <li>If you miss to visit at fittment center at Appointment Date Time you can
                                        take
                                        Re-Appointment Online useing above mentioned successful Order ID
                                    </li>
