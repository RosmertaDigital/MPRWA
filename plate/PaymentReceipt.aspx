<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaymentReceipt.aspx.cs" Inherits="BMHSRPv2.plate.PaymentReceipt" %>
            ...
            <div class="color1 view-data">
                <div class="in_pages page1 clearfix">
                    <div class="addedspace width50 width40">
                        ...
                        <div class="qr" id="divRQCode" runat="server">
                    ...
                    <div class="addedspace printpage width50 width60" >
                        <div class="printarea">
                            <div class="white">
                                ...
                                <div class="table-show" id="divControlsRow" runat="server">
                                    <table>
                                        <tr>
                                            <td>Order Date :</td>
                                            <td>
