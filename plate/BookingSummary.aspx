<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BookingSummary.aspx.cs" Inherits="BMHSRPv2.plate.BookingSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ul>
        ...
        <div class="backbtn" data-act="page10">
        <a href="AppointmentSlot.aspx" class="gobacks"><img src="../assets/img/back.svg"></a>
    </div>
</div>   --%>
