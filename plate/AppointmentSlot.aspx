<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AppointmentSlot.aspx.cs" Inherits="BMHSRPv2.plate.AppointmentSlot" %>
    ...
    <div class="app clearfix">
        ...
        <li><a href="#"><span>Step 6</span> Download Receipt </a></li>
                ...
                <div class="backbtn" data-act="page3">
                    <a  href="Dealers.aspx" style="display:none" class="gobacks">
                        <img src="../assets/img/back.svg"></a>
                </div>
            </div>
