<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReAppointmentPay.aspx.cs" Inherits="BMHSRPv2.ReAppointmentPay" %>
<%@ Register Src="~/ucPageHeader.ascx" TagPrefix="uc1" TagName="ucPageHeader" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="section">
                    ...
                    <ul class="menu">
                        <li><a href="../Document/Pincode.pdf" target="_blank" style="color: black"><b>CHECK FOR HOME DELIVERY</b></a></li>
                        ...
                        <li><a href="#"><span style="color: red">(coming soon)</span>
                            <br />
                            &nbsp;&nbsp;Corporate Bookings </a></li>
                    </ul>
                ...
                <uc1:ucPageHeader runat="server" id="ucPageHeader" />
                <div class="app clearfix">
                    <section class="after">
                        <div class="steps bars color1" style="display:none">
                            ...
                            <div class="backbtn" data-act="page11">
                                <a href="page12.html" class="gobacks">
                        ...
                        <div class="color2 view-data">
                            <div class="in_pages page1 clearfix">
                                ...
                                <div class="rightside">
                                    <div class="addedspace">
                                        ...
                                        <div class="summary clearfix">
                                            <div class="width50 padd0">
                                                 <h5>Order number: 
                                                    <asp:Label ID="lblOrderNo" runat="server"  style="font-size: 12.86pt;color: #39435b;font-weight: 600;"></asp:Label>
                                                </h5>
                                                <%--<span>Owner Name
                                                </span>
                                                <p>
                                    ...
                                    <span>Previous Appointment Date</span>
                                    <p><asp:Literal runat="server" ID="LitPreviousDate"></asp:Literal></p>
                                    <span>Previous Appointment Time Slot</span>
                                    <p><asp:Literal runat="server" ID="LitPreviousTime"></asp:Literal></p>

                                    <span>New Appointment Date</span>
                                    <p><asp:Literal runat="server" ID="LitNewDate"></asp:Literal></p>
                                    <span>New Appointment Time Slot</span>
                                    <p><asp:Literal runat="server" ID="LitNewTime"></asp:Literal></p>
                                                <script>
                                            ...
                                            <div class="width50">
                                                <div class="right-pay">
                                                    <div class="popup" runat="server" id="DivPaymentSummary">
                                                        <table>
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><span>Reschedule Charges</span></td>
                                                                    <td>
                                                           ...
                                                           <%--     <tr style="display: none;">
                                                              ...
                                                              <%--  <tr>
                                                                ...
                                                                <tr class="removeline" id="divtrGST" runat="server">
                                                                    <td><span>GST @ 18%</span></td>
                                                                    <td>
                                                                        <asp:Label ID="lblGST" runat="server" Text="Rs. 0"></asp:Label></td>
                                                                </tr>
                                                                <tr class="removeline" id="divtrIGST" runat="server">
                                                    ...
                                                    <div class="center">
                                                        <%--<a href="#" style="float: left;" class="btn isforwardprint">Add More Products</a>--%>
                                                         <asp:Button ID="BtnSubmit" runat="server"  Text="Submit" OnClick="BtnSubmit_Click" class="filled btn isforwardsummary" />
                                                          <asp:HiddenField ID="hdnMyOrderID" runat="server" />
                                                        <asp:HiddenField ID="hdnGatewayOrderID" runat="server" />
                                                        <asp:Button ID="btnPayNow" runat="server" OnClick="btnPayNow_Click" Text="Pay Online" class="filled btn isforwardsummary" />
                                                         <asp:HiddenField runat="server" ID="HiddenlblRescheduledOrderid" />
                                                        <asp:Button ID="btnPrint" Visible="false" runat="server" OnClick="btnPrint_Click" Text="Print" class="filled btn isforwardsummary" />
                                                    </div>
                                                </div>
                                            </div>
        ...
        <ul>   
         ...
         <%--   <li><a href="../BookMyHSRP_ContactUs.aspx" style="color:black"><b>Grievance Redressal</b></a></li>--%>
            <li><a href="../GrievanceSelectState.aspx" style="color:black"><b>Grievance Redressal</b></a></li>
              <marquee behavior="scroll" direction="left" scrollamount="10" style="font-weight: 600;color: #b11b20;font-size: 13.87pt;" onMouseOver="this.stop()" onMouseOut="this.start()"  > <a href="../PinForHomeDelivery.aspx" target="_blank">Started Home delivery services in Lucknow. Also, Home Delivery services are available in Ghaziabad, Noida and Greater Noida. New Locations Added for Home Delivery in Delhi List may be checked at “AVAILABLE PIN CODES”.</a> </marquee>
    ...
    <script src="../assets/js/app.js?1603105714"></script>
