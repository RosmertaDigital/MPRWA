<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AppointmentSlot.aspx.cs" Inherits="BMHSRPv2.sticker.AppointmentSlot" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        ...
        function CheckECBlockedDate(BindDates, AvaiableSlotFromDates) {
            ...
            return jQuery.ajax({
                type: "POST",
                url: "AppointmentSlot.aspx/CheckECBlockedDates",
        ...
        function timeSlotBinding(SelectedDate) {
            ...
            return jQuery.ajax({
                type: "POST",
                url: "AppointmentSlot.aspx/BindingTimeSlot",
    ...
    <div class="app clearfix">
        <section class="after">
            <uc1:ucStepBar runat="server" id="ucStepBar" PageStep="8" BackPage="DeliveryPoint.aspx" />
