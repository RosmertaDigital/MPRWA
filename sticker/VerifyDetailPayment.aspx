<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyDetailPayment.aspx.cs" Inherits="BMHSRPv2.sticker.VerifyDetailPayment" %>
                                        ...
                                        <div class="summary clearfix">
                                            <div class="width50 padd0">
                                                ...
                                                <p style="display:none;">
                                                    <asp:Label ID="lblPinCode" runat="server" Text="" Style="font-size: 12.86pt; color: #39435b; font-weight: 300;"></asp:Label>
                                                ...
                                                <div class="right-pay">
                                                    <div class="popup">
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td><span>Sticker Cost (Included Fitment Cost)</span></td>
                                                                    <td>
                                                                ...
                                                                <tr id="trDeliveryCharge" runat="server" style="display: none;">
