...
namespace BMHSRPv2.sticker
{
    public partial class AppointmentSlot : System.Web.UI.Page
    {
        ...
        
        {
            ...
            if (!CheckSession.Checksession1(12, "sticker"))
            {
            ...
            if (!IsPostBack)
            {
               ...
               SetSideBar();
                //if ( Session["S_OrderType"] != null && Session["S_OrderType"].ToString().Length > 0 &&
                //     Session["S_VehicleTypeID"] != null && Session["S_VehicleTypeID"].ToString().Length > 0)
                //{
        ...
        private void LoadDataTable()
        {
            ...
            SQLAppointmentFromDate = "CheckAppointmentFromDate '" + Session["S_OEMId"].ToString() + "', '" + Session["S_DealerAffixationCenterid"].ToString() + "','" + Session["S_VehicleTypeid"].ToString() + "','" + Session["S_DeliveryPoint"].ToString() + "' ,'" + Session["S_StateId"].ToString() + "','Sticker','" + Session["NonHomo"].ToString() + "' "; 
        ...
        public static List<string> CheckECBlockedDates(string checkDate, string avaiableSlotFrom)
        {
            ...
            try
            {
                ...
                while (tempDate <= endDate)
                {
                   ...
                   // AppointmentBlockedDatesQuery = "CheckECAppointmentBlockedDates '" + tempDate.ToString("yyyy-MM-dd") + "', '" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','Sticker' ";
                    AppointmentBlockedDatesQuery = "CheckAppointmentBlockedDates_EcDealer '" + tempDate.ToString("yyyy-MM-dd") + "', '" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','Sticker' ";
        ...
        public static string BindingTimeSlot(string SelectedDate)
        {
            ...
            try
            {
                ...
                string AppointmentBlockedDatesQuery = "CheckECAppointmentBlockedDates '" + SelectedDate + "', '" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','Sticker' ";
                System.Data.DataTable dtAppointmentBlockedDates = BMHSRPv2.Models.Utils.GetDataTable(AppointmentBlockedDatesQuery, ConnectionString);
                ...
                if (dtAppointmentBlockedDates.Rows.Count > 0)
                {
                    ...
                    if (Status == "0" && SelectedDateTime.DayOfWeek != DayOfWeek.Sunday && HttpContext.Current.Session["S_DeliveryPoint"].ToString() == "Dealer")
                    {
                        sqlQuery = "CheckApointmentTimeSlot'" + SelectedDate + "','" + HttpContext.Current.Session["S_VehicleTypeid"].ToString() + "','" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','" + HttpContext.Current.Session["S_StateId"].ToString() + "','Sticker' "; //Session["S_StateId"].ToString()
                    }

                    if (Status == "0" && HttpContext.Current.Session["S_DeliveryPoint"].ToString() == "Home")
                    {
                        sqlQuery = "CheckApointmentTimeSlot_Home '" + SelectedDate + "','" + HttpContext.Current.Session["S_VehicleTypeid"].ToString() + "','" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','" + HttpContext.Current.Session["S_StateId"].ToString() + "',Sticker "; //Session["S_StateId"].ToString()
                    }
                    ...
                    if (sqlQuery != null && sqlQuery.Length > 0)
                    {
                        ...
                        ////sqlQuery = "EXEC [dbo].[jsp_BHSRP_GET_TIME_SLOT] @VehicleTypeID=" + HttpContext.Current.Session["S_VehicleTypeid"].ToString() + ",@RTOCodeID=" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "";
                        ...
                        //{
                        //    sqlQuery = "CheckApointmentTimeSlot '" + SelectedDate + "','" + HttpContext.Current.Session["S_VehicleTypeid"].ToString() + "','" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','" + HttpContext.Current.Session["S_StateId"].ToString() + "' "; //Session["S_StateId"].ToString()
                        //    dtTimeSlot = BMHSRPv2.Models.Utils.GetDataTable(sqlQuery, ConnectionString);
                        //}

                        //else if (HttpContext.Current.Session["S_DeliveryPoint"].ToString() == "Home")
                        //{

                        //    sqlQuery = "CheckApointmentTimeSlot_Home '" + SelectedDate + "','" + HttpContext.Current.Session["S_VehicleTypeid"].ToString() + "','" + HttpContext.Current.Session["S_DealerAffixationCenterid"].ToString() + "','" + HttpContext.Current.Session["S_DeliveryPoint"].ToString() + "','" + HttpContext.Current.Session["S_StateId"].ToString() + "' "; //Session["S_StateId"].ToString()
                        //    dtTimeSlot = BMHSRPv2.Models.Utils.GetDataTable(sqlQuery, ConnectionString);
                        //}
        ...
        protected void btnTimeSlotSelection_Click(object sender, EventArgs e)
        {
            ...
            {
                LiteralMessage.Text = "<Alert> Choose Booking date </Alert>";
                return;
            }
            if (SlotIDWithTimeSlot.Length == 0)
            {
                LiteralMessage.Text = "<Alert> Choose Booking Time Slot </Alert>";
                return;
            }
            ...
            string AppointmentBlockedDatesQuery = "CheckECAppointmentBlockedDates '" + SlotDate + "', '" +Session["S_DealerAffixationCenterid"].ToString() + "','" + Session["S_DeliveryPoint"].ToString()+ "','Sticker' ";
            System.Data.DataTable dtAppointmentBlockedDates = BMHSRPv2.Models.Utils.GetDataTable(AppointmentBlockedDatesQuery, ConnectionString);
            ...
            if (dtAppointmentBlockedDates.Rows.Count > 0)
            {
                ...
                if (Status == "1")
                {
                    ...
                    LiteralMessage.Text = "<Alert> All Slot Booked. Choose another date. </Alert>";
                    return;
                    
                }
                else
                {
                    Session["S_SelectedSlotID"] = SlotID;
                    Session["S_SelectedSlotDate"] = SlotDate;
                    Session["S_SelectedSlotTime"] = SlotTime;
